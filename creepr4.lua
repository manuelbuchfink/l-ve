...
function Creepr4:init(map)
    ...
    self.y = map.tileHeight * (map.mapHeight - 32) - self.height
...
function Creepr4:calculateJumps()
...
function Creepr4:checkLeftCollision()
    if self.dx < 0 then
        -- check if there's a tile directly beneath us
...
function Creepr4:checkRightCollision()
    if self.dx > 0 then
        -- check if there's a tile directly beneath us
