...
function Player:init(map)
    ...
    self.animations = {
        ['idle'] = Animation({
            ...
            frames = {
                love.graphics.newQuad(0, 7, 15, 20, self.texture:getDimensions())
            }
        }),
        ['walking'] = Animation({
            texture = self.texture,
            frames = {
                love.graphics.newQuad(16, 7, 15, 20, self.texture:getDimensions()),
                love.graphics.newQuad(32, 7, 15, 20, self.texture:getDimensions()),
                love.graphics.newQuad(48, 7, 15, 20, self.texture:getDimensions()),
        ...
        ['falling'] = Animation({
            texture = self.texture,
            frames = {
                love.graphics.newQuad(128,0,16,24, self.texture:getDimensions())
            }
        }),
        ['dash'] = Animation({
            texture = self.texture,
