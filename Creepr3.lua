...
function Creepr3:init(map)
    ...
    self.y = map.tileHeight * (map.mapHeight - 28) - self.height
...
function Creepr3:calculateJumps()
...
function Creepr3:checkLeftCollision()
    if self.dx < 0 then
        -- check if there's a tile directly beneath us
...
function Creepr3:checkRightCollision()
    if self.dx > 0 then
        -- check if there's a tile directly beneath us
